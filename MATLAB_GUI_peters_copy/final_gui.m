...
% Last Modified by GUIDE v2.5 05-May-2018 15:41:24
...
set(handles.figure1, 'Name', 'VeriFace GUI');
...
% handles    structure with handles and user data (see GUIDATA)
    ...
    if quality == 2
        ...
        min_dist = id.min_dist
        id.num;

        if confidence > 0.95    % let them in if really high confidence
        ...
        elseif confidence > 0.50 % this is the medium confidence case
